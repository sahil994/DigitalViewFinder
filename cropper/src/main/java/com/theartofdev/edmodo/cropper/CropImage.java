...
public final class CropImage {
    ...
    public static int mRows, mColumn;
    ...
    public static void startPickImageActivityOnlyCamera(@NonNull Activity activity) {
        activity.startActivityForResult(getPickImageChooserIntentOnlyCamera(activity), PICK_IMAGE_CHOOSER_REQUEST_CODE);
    }
    ...
    public static Intent getPickImageChooserIntentOnlyCamera(@NonNull Context context) {
        return getPickImageChooserIntentOnlyCamera(context, context.getString(R.string.pick_image_intent_chooser_title), false);
    }
    ...
    public static Intent getPickImageChooserIntentOnlyCamera(@NonNull Context context, CharSequence title, boolean includeDocuments) {
    ...
    public static final class ActivityBuilder {
         ...
         */
        public ActivityBuilder setGuidelines(@NonNull CropImageView.Guidelines guidelines, int row, int colummn) {
        ...
        public int setColumn(int row, int column) {
